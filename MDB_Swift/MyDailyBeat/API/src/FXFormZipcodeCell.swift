...
//
import FXForms
class FXFormZipcodeCell: FXFormDefaultCell, UITextFieldDelegate {
    ...
    override func layoutSubviews() {
        ...
        labelFrame?.size.width = min(CGFloat(240), max(CGFloat(97), (self.textLabel?.sizeThatFits(CGSize.zero).width)!))
